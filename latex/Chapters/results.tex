...
The cats and dogs dataset is a collection of \numprint{25000} pictures, of which half are cats and half are dogs.
...
\begin{figure}[H]
    \centering
    \subfloat[Our Predictive entropy.]{\includegraphics[width=0.5\textwidth]{cats_dogs_accuracies_pred_ent_ribbon}}
    \hfill
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=\textwidth]{cats_dogs_accuracies_pred_ent_ribbon}
%     \caption{Accuracy of models in each acquisition step in the cats and dogs dataset.}
%     \label{fig:cats_dogs_accuracies_pred_ent_ribbon}
% \end{figure}
%
%
%
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=\textwidth]{cats_dogs_accuracies_var_ratios_ribbon}
%     \caption{Accuracy of models in each acquisition step in the cats and dogs dataset.}
%     \label{fig:cats_dogs_accuracies_var_ratios_ribbon}
% \end{figure}
