...
In machine learning it is common to assume that observations are i.i.d. and thus, it is also common to find the need to solve optimization problems of the form
\begin{equation}
