...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{KL_example_1,pdf}
         \caption{$y=x$}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{KL_example_2.pdf}
         \caption{$y=3sinx$}
...
%         \centering
%         \includegraphics[height=1.2in]{KL_example_1.pdf}
%         \caption{Lorem ipsum}
%     \end{subfigure}%
%     ~
%     \begin{subfigure}[t]{0.5\textwidth}
%         \centering
%         \includegraphics[height=1.2in]{KL_example_2.pdf}
%         \caption{Lorem ipsum, lorem ipsum,Lorem ipsum, lorem ipsum,Lorem ipsum}
%     \end{subfigure}
%     \caption{Approximations using forward and reverse KL-divergence.}
...
%     \centering
%     \includegraphics[width=.8\linewidth]{KL_example_1.pdf}}
%     \caption{1a}
%     \label{fig:KL_example_sfig_1}
%   \end{subfigure}%
%   \begin{subfigure}{.5\textwidth}
%     \centering
%     \includegraphics[width=.8\linewidth]{KL_example_1.pdf}}
%     \caption{1b}
%     \label{fig:KL_example_sfig_2}
%   \end{subfigure}
%   \caption{Approximations using forward and reverse KL-divergence.}
%   \label{fig:KL_example}
% \end{figure}
...
%     \centering
%     \begin{multicols}{2}
%         \includegraphics[width=\linewidth]{KL_example_1.pdf}\par
%         \includegraphics[width=\linewidth]{KL_example_2.pdf}\par
%     \end{multicols}
%     \caption{Approximations using forward and reverse KL-divergence.}
%     \label{fig:KL_example}
% \end{figure}
